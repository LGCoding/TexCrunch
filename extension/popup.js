...
function getSettings() {
    return __awaiter(this, void 0, void 0, function* () {
        const settings = yield chrome.storage.local.get(["decimalPlaces", "format"]);
        if (typeof settings.decimalPlaces !== "number")
            settings.decimalPlaces = 10;
        if (![
            "fixed",
            "exponential",
            "engineering",
...
window.onload = () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    decimalElement.onchange = (e) => {
        chrome.storage.local.set({
            decimalPlaces: Number(e.currentTarget.value),
        });
    };
});
